package com.samyak.doubletapplayerview.youtube
...
import com.samyak.doubletapplayerview.PlayerDoubleTapListener
import com.samyak.doubletapplayerview.R
import com.samyak.doubletapplayerview.SeekListener
import com.samyak.doubletapplayerview.youtube.views.CircleClipTapView
import com.samyak.doubletapplayerview.youtube.views.SecondsView
...
class YouTubeOverlay(context: Context, private val attrs: AttributeSet?) :
    ...
    interface PerformListener {
         ...
         *
         * In the following you see the default conditions for each action:
         *
         ...
         * @param playerView [DoubleTapPlayerView] which accepts the taps
